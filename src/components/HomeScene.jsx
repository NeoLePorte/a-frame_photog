...
//this is the sphere component that is used in the FibonacciSpiral component.
...
//this is the FibonacciSpiral component that is used in the HomeScene component. it is a spiral of spheres. 
const FibonacciSpiral = ({ n }) => {
  ...
  return spirals.map((pos, i) => (
    <Sphere
      ...
      position={pos}
      rotation={{ x: 90, y: i * 10, z: 90 }}
      id={`sphere-${i}`}
    />
  ))
}
//this is the HomeScene component that is used in the App component. it is the main scene that is rendered.
export default function HomeScene() {
  ...
  useLayoutEffect(() => {
    ...
    //this is the animation for the spheres in the FibonacciSpiral component.
    ...
    <Scene>
      ...
      <Entity>
        ...
        <Entity
          ...
          intensity="10"
          color="#adff48"
          position="0.9683026062919912 10 -0.176770114444802"
        />
        <Entity
          primitive="a-light"
          type="ambient"
          intensity="10"
          color="#a8ff50"
          position="0.9683026062919912 0 -0.176770114444802"
        />
